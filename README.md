...
- 상세 보기의 하단 버튼을 누르면 편집을 하도록 화면 연결

### 20. 메모 편집

- 메모 편집 기능 구현
- 수정이 됐을 때 바로 반영하기 위해 새로운 notification 추가

### 21. 편집 취소 확인

- 내용을 변경했을 때 실수로 취소를 누를 경우를 대비해서 취소 확인 기능 추가
...
- 내용이 너무 길어질때 키보드에 가려 텍스트가 안보여지는 경우 처리가 필요함
